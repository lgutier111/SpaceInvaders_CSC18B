...
import static SpaceInvaders_V3.formwindow.RegexCheck.validateEmail;
import static SpaceInvaders_V3.formwindow.RegexCheck.validateFirstName;
import static SpaceInvaders_V3.formwindow.RegexCheck.validateLastName;
import static SpaceInvaders_V3.formwindow.RegexCheck.validatePassword;
import static SpaceInvaders_V3.formwindow.RegexCheck.validateUsername;
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        if (!FNErr && !LNErr && !emailErr && !UNErr && !PW1Err && !PW2Err) {
            ...
            try {
                ...
                st.setString(1, firstName.getText().trim());
                st.setString(2, lastName.getText().trim());
                st.setString(3, email.getText().trim());
                st.setString(4, userName.getText().trim());
                st.setString(5, password1Input);
